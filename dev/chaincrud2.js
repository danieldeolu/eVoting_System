...
var url = 'mongodb+srv://admin:admin123@cluster0.1ynwr.mongodb.net/' //second node url
//var url = 'mongodb+srv://admin:admin123@daniel-d1wwk.mongodb.net/'

//this is the crud code the distribution of DB operations
var dbName = 'MyDB';
...
var Words = mongoose.model('storage2', wordSchema, colName);   //note that this.colName specifies the column
